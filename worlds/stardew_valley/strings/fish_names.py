...
class PKMNFish:
    ...
    dratini = "Dratini"
    feebas = "Feebas"
    frillish_female = "Female Frillish"
    frillish_male = "Male Frillish"
    finneon = "Finneon"
    goldeen = "Goldeen"
    grimer = "Grimer"
    horsea = "Horsea"
    ...
    kyogre = "Kyogre"
    lotad = "Lotad"
    lotad_shiny = "Shiny Lotad"
    luvdisc = "Luvdisc"
    luvdisc_shiny = "Shiny Luvdisc"
    magikarp = "Magikarp"
    magikarp_shiny = "Shiny Magikarp"
    poliwag = "Poliwag"
    surskit = "Surskit"
    tadbulb = "Tadbulb"
    tatsugiri_curly = "Curly Tatsugiri"
    tatsugiri_droopy = "Droopy Tatsugiri"
    tatsugiri_stretchy = "Stretchy Tatsugiri"
    tentacool = "Tentacool"
    trubbish = "Trubbish"
    tympole = "Tympole"
    tynamo = "Tynamo"
    ...
    wooper = "Wooper"
    wooper_shiny = "Shiny Wooper"
    clamperl = "Clamperl"
    clamperl_shiny = "Shiny Clamperl"
    shellder = "Shellder"
    shellder_shiny = "Shiny Shellder"
